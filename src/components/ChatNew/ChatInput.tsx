    ...
    return (
      <>
       <motion.form
        ...
        className="flex sticky max-w-8xl items-center justify-center gap-2 p-4 bg-white shadow-md hover:shadow-lg rounded-lg border border-gray-300 min-h-40 w-[70%]"
