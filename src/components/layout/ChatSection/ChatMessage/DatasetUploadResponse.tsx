...
const DatasetUploadResponse = ({
  ...
  return (
    <div
      className="flex flex-col m-auto text-base py-2 w-full max-w-full overflow-x-hidden px-4 sm:px-6 lg:px-8"
      ref={containerRef}
    >
      {fileName && (
        <>
          <div
            ...
            onClick={() =>
              handlePreviewClick(
                `s3://growmax-dev-app-assets/analytics/${fileName}`
              )
            }
          >
            <div>
